...
int insertar_en_arbol_bin_busq(t_arbol* pa, const t_dato* pd, t_cmp cmp);
int insertar_en_arbol_bin_busq_res(t_arbol* pa, const t_dato* pd, t_cmp cmp);
int buscar_en_arbol_bin_busq(const t_arbol* pa, t_dato* pd, t_cmp cmp);
int buscar_en_arbol_bin_busq_res(const t_arbol* pa, t_dato* pd, t_cmp cmp);
