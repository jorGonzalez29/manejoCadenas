...
//    return cant;
//
////    Cuenta el número de caracteres de una subcadena inicial apuntada por s1 que no
////contenga ninguno de los caracteres en la cadena apuntada por s2.
////La función retorna el número de caracteres leídos de la subcadena hasta que halla
////alguno de los caracteres de s2. El carácter nulo no se cuenta.
//}
...
////    La función retorna la cadena de caracteres conteniendo el mensaje asociado con el número
////de error. Esta conversión y el contenido del mensaje dependen de la implementación. La
////cadena no será modificada por el programa, pero sí puede ser sobrescrito con otra llamada a
////la misma función.
//}
...
////son añadidos) de la cadena apuntada por s2 al final de la cadena apuntada por s1. El
////carácter inicial de s2 sobrescribe el carácter nulo al final de s1. El carácter nulo
